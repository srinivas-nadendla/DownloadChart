...
folder are mapped to the application's root namespace, 'ChartToImgOrPdf'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "ChartToImgOrPdf"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'ChartToImgOrPdf' in the same way
as `"ChartToImgOrPdf/sass/src"`.
